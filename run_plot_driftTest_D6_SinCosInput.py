...
if __name__ == '__main__':
    ...
    # drift_test_result_path_lst = [join("data", ARM_NAME + '_' + SN, "real", "dirftTest", "N4", 'D6_SinCosInput', "dual","archive","result1"),
    #                               join("data", ARM_NAME + '_' + SN, "real", "dirftTest", "N4", 'D6_SinCosInput', "dual","archive","result2")]
    drift_test_result_path_lst = [join("data", ARM_NAME + '_' + SN, "real", "dirftTest", "N4", 'D6_SinCosInput', "dual","result")]
